...
const Sidebar = () => {
  ...
  if (user?.role === 'seller') {
    // Insert after "Store Management" which is at index 3
    sidebarItems.splice(4, 0, { id: 'add-product', path: '/add-product', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>, label: 'Add New Item' });
  }

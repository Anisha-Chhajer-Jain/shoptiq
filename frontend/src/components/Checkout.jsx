...
const Checkout = ({ total = 132.62, onComplete }) => {
      ...
      <div className="checkout-grid">
        <div className="checkout-main">
          ...
          <section className="checkout-card">
            ...
            <div className="checkout-form-grid">
              ...
              <div className="form-group full">
                ...
                <input type="text" placeholder="123 Commerce Way, Suite 400" />
              </div>
              <div className="form-group">
                <label>City</label>
          ...
          <section className="checkout-card">
            ...
            <div className="payment-tabs">
              <div className={`payment-tab ${payment === 'now' ? 'active' : ''}`} onClick={() => setPayment('now')}>
                <div className="radio-check"></div>
                <strong>Pay Now</strong>
              </div>
              <div className={`payment-tab ${payment === 'store' ? 'active' : ''}`} onClick={() => setPayment('store')}>
                <div className="radio-check"></div>
              ...
              <div className="cc-form">
                ...
                <div className="form-group full">
                  ...
                  <div className="cc-input-wrap">
                    ...
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
                  </div>
                </div>
                <div className="form-group">
                  <label>Expiry</label>
        ...
        <aside className="checkout-sidebar">
          <div className="order-summary-card">
            ...
            <button className="btn-confirm-purchase" onClick={onComplete}>
               Confirm Purchase
